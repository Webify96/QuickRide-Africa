...
function buildEmail(d) {
  ...
  return (
    ...
    '<td style="padding:10px 0;font-size:14px;color:#111827;font-family:Arial,sans-serif;border-bottom:1px solid #f3f4f6;">' +
    name +
    "</td></tr>" +
    ...
    '<td style="padding:10px 0;font-size:14px;font-family:Arial,sans-serif;border-bottom:1px solid #f3f4f6;"><a href="mailto:' +
    email +
    '" style="color:#b8922a;text-decoration:none;">' +
    email +
    "</a></td></tr>" +
    (phone
      ? '<tr><td style="padding:10px 0;font-size:13px;color:#6b7280;font-family:Arial,sans-serif;border-bottom:1px solid #f3f4f6;">Phone</td>' +
        '<td style="padding:10px 0;font-size:14px;color:#111827;font-family:Arial,sans-serif;border-bottom:1px solid #f3f4f6;">' +
        phone +
        "</td></tr>"
      : "") +
    (company
      ? '<tr><td style="padding:10px 0;font-size:13px;color:#6b7280;font-family:Arial,sans-serif;border-bottom:1px solid #f3f4f6;">Company</td>' +
        '<td style="padding:10px 0;font-size:14px;color:#111827;font-family:Arial,sans-serif;border-bottom:1px solid #f3f4f6;">' +
        company +
        "</td></tr>"
      : "") +
    ...
    '<p style="margin:0;font-size:14px;color:#374151;font-family:Arial,sans-serif;line-height:1.75;">' +
    message +
    "</p>" +
    "</div>" +
    "</div>" +
